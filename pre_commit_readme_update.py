...
ALL_CATEGORIES = [TAG_BIT, TAG_SIM, TAG_DESIGN, TAG_LINKED_LIST, TAG_BINARY_SEARCH, TAG_TP, TAG_DP,
                  TAG_BFS, TAG_BT, TAG_DC, TAG_DFS, TAG_HASH, TAG_GREEDY, TAG_BINARY_SEARCH_TREE, 
