...
| 046.permutations | [cpp](./leetcode/46.permutations.cpp), [python](./leetcode/46.permutations.py) | O(N * N!) | O(N) | Medium/S-- | DFS | Perfect
| 47.permutations-ii | [cpp](./leetcode/47.permutations-ii.cpp), [python](./leetcode/47.permutations-ii.py) | O(N * N!) | O(N) | Medium/S++ | DFS | Perfect
